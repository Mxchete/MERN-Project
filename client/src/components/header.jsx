  ...
  return (
    <header className="flex items-center w-full p-4 md:py-2 md:px-6">
        ...
        <ul className='flex items-center justify-center ml-7'>
            ...
            <li className='mx-5 text-lg'><NavLink to={'/premium'} className={({isActive}) => isActive ? isActiveStyles : isNotActiveStyles}>Prenium</NavLink></li>
        ...
        className='flex items-center ml-auto cursor-pointer gap-2 relative'>
            ...
            {isMenu && (
                ...
                exit={{opacity : 0, y : 50}}
                className='absolute z-10 top-12 right-0 p-4 w-275 gap-2 bg-card shadow-lg rounded-lg backdrop-blur-sm flex flex-col'>
