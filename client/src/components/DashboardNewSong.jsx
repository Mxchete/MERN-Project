...
export const ImageUploader = ({
  ...
  return (
    <label>
      <div className="flex flex-col items-center justify-center h-full cursor-pointer hover:bg-red-900">
...
const DashboardNewSong = () => {
  ...
  useEffect(() => {
    // When the component is unmounted, update the ref
    return () => {
    ...
    <div className="flex items-center justify-center p-4 border border-gray-300 rounded-md">
      <div className="flex flex-col items-center justify-center gap-4">
        <input
          ...
          className="w-full p-3 rounded-md text-base font-semibold text-textColor focus:border-red-500 focus:placeholder-red-900 outline-none shadow-sm border border-gray-300 bg-transparent"
          value={songName}
        ...
        <div className="flex items-center justify-between gap-2 w-full flex-wrap">
          ...
          <div className="flex items-center justify-end w-full p-4">
            {isImageLoading || isAudioLoading ? (
              ...
              <motion.button
                whileTap={{ scale: 0.75 }}
                className="px-8 py-2 rounded-md text-white bg-red-600 hover:shadow-lg-red hover:bg-white hover:text-black"
                onClick={saveSong}
              >
                Upload Song
              </motion.button>
